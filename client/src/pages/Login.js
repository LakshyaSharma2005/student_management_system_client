...
const styles = {
  ...
  logoCircle: {
    fontSize: '45px', marginBottom: '10px', 
    filter: 'drop-shadow(0 0 15px rgba(255, 215, 0, 0.4))'
  },
  title: { margin: '0', color: '#fff', fontSize: '26px', fontWeight: '800', letterSpacing: '1px' },
  ...
  floatingLabel: {
    ...
    color: '#a0a0c0', fontSize: '16px', pointerEvents: 'none',
  ...
  button: {
    ...
    color: '#332200', border: 'none', borderRadius: '12px',
    fontSize: '16px', fontWeight: '800', cursor: 'pointer',
    marginTop: '10px', boxShadow: '0 5px 20px rgba(253, 185, 49, 0.3)',
  ...
  footer: { textAlign: 'center', marginTop: '30px', fontSize: '13px', color: '#8888aa' },
  ...
  modalCard: {
    ...
    border: '1px solid #FFD700', boxShadow: '0 0 30px rgba(255, 215, 0, 0.2)'
  },
